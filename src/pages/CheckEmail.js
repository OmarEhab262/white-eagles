  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const pinResponse = await axios.post(
        "https://sterling-owl-profound.ngrok-free.app/api/verify/pin",
      ...
      const resetResponse = await axios.post(
        "https://sterling-owl-profound.ngrok-free.app/api/reset-password",
        {
          email,
      ...
      window.location.href = "/WhiteEagles/#/SuccessfulPassword";
    } catch (error) {
  ...
  const handleResendPIN = async () => {
    try {
      ...
      const resetCode = await axios.post(
        "https://sterling-owl-profound.ngrok-free.app/api/password/resend-pin",
        { email },
        {
          headers: {
            "Content-Type": "application/json",
